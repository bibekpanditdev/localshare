...
*   **🎨 Windows 11 Design**: A clean, "Acrylic" web interface that feels native to your PC.
*   **🔒 Privacy First**: No cloud, no internet, no tracking. Your files never leave your local network.
*   **📂 Multi-Root Support**: Share your dedicated app folder, your full internal storage, and even your SD card simultaneously.
...
### 1. Installation
*   **Phone**: Download the latest APK from the [Releases Page](https://github.com/bibekpanditdev/localshare/releases) and install it on your Android device.
*   **PC**: No installation required! Any modern browser (Chrome, Edge, Firefox) works.
...
## 📄 Documentation
Detailed architecture, technology stack, and roadmap information can be found in the [DESCRIPTION.md](./DESCRIPTION.md) file.
